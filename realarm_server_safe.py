...
app = Flask(__name__)
SHOW_MATPLOTLIB = os.environ.get("THINKGRASP_SHOW_MATPLOTLIB", "1") == "1"
SHOW_OPEN3D = os.environ.get("THINKGRASP_SHOW_OPEN3D", "0") == "1"
...
def get_args_parser():
    ...
    parser.add_argument(
        '--checkpoint_grasp_path',
        default=os.environ.get('THINKGRASP_CHECKPOINT_GRASP_PATH', 'logs/checkpoint_fgc.tar'),
...
def get_grasp_pose():
    ...
    try:
        ...
        logging.exception("Error while handling /grasp_pose request")
